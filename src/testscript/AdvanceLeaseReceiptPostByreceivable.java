...
public class AdvanceLeaseReceiptPostByreceivable extends BaseTest
{
	@Test
	public void ReceiptApplicationByReceivablesSmokeTest() throws InterruptedException, IOException
	{
		//Fetching data from xl
		String leaseSeqNumber=excel.getCellValue("./TestData/Input.xlsx", "AssetProfile", 2,0);
