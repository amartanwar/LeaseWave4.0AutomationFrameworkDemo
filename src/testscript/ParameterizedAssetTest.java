...
public class ParameterizedAssetTest extends BaseTest
{
	@Test(priority=0)
	@Parameters({"sUnitNumber"})
	public void CreatingAssetForArrearsLeaseTest(String sUnitNumber) throws InterruptedException, IOException 
	{
