...
public class ReceiptPostingPartiallyPaid extends BaseTest
{
	@Test
	public void ReceiptPartiallypostingSmokeTest() throws InterruptedException, IOException
	{
...
//		is.enterLeaseSequenceNumber(leaseSeqNumber);
		...
		ra.selectOneInvoices();
		
		ra.enterpatialAmount("20");
		
		//click on apply
		Thread.sleep(3000);
		ra.clickOnApplyButton();
